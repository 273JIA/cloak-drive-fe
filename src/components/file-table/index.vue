            ...
            <el-table-column
                ...
                <template #default="scope">
                    ...
                    <div class="file-operation-content">
                        ...
                        <el-tooltip class="item" effect="light" content="Rename" placement="top">
                        ...
                        <el-tooltip class="item" effect="light" content="Share" placement="top">
                            <share-button size="small" circle-flag :item="scope.row"/>
                        </el-tooltip>
                        <el-tooltip class="item" effect="light" content="Copy" placement="top">
                            <copy-button size="small" circle-flag :item="scope.row"/>
                        </el-tooltip>
                        <el-tooltip class="item" effect="light" content="Move" placement="top">
