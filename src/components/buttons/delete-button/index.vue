...
const doDeleteFile = (fileIds) => {
    ElMessageBox.confirm('Files will be saved in the recycle bin after deletion, are you sure about this?', 'Delete file', {
...
const deleteFile = () => {
    ...
    ElMessage.error('Please select files to delete')
}
</script>
